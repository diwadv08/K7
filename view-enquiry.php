...
<div class="nk-content">
    ...
    <div class="nk-block-head-content">
        <h2 class="nk-block-title">View Enquiry</h1>
...
<div class="form-control-wrap">
    ...
    <div class="col-lg-6">
<div class="form-group"><label for="category" class="form-label">Business Type</label>
<div class="form-control-wrap">
<input type="text" class="form-control" id="category" name="category" value="<?=$fe['b_type'];?>" readonly>
    </div>
    </div>
    </div>
<div class="col-lg-6">
<div class="form-group"><label for="mobile_num" class="form-label">Quantity</label>
<div class="form-control-wrap">
<input type="text" class="form-control" maxlength="10" id="mobile_num" name="mobile_num" value=<?=$fe['quantity'];?> readonly></div></div></div>
<div class="col-lg-6">
...
<div class="form-control-wrap">
<input type="text" class="form-control" maxlength="10" id="mobile_num" name="mobile_num" value=<?=$fe['email'];?> readonly></div></div></div>
<div class="col-lg-6">
<div class="form-group"><label for="address" class="form-label">Address</label>
<div class="form-control-wrap">
     <input class="form-control" id="address" name="address" placeholder="Enter your address" value="<?=$fe['address'];?>" readonly></div></div></div>
<div class="col-lg-6">
<div class="form-group"><label for="address" class="form-label">Remarks</label>
<div class="form-control-wrap">
     <input class="form-control" id="address" name="address" placeholder="Enter your address" value="<?=$fe['remarks'];?>" readonly></div></div></div>
</div> 
</body>
</html>
