...
<div class="nk-content">
    ...
    <div class="nk-block-head-content">
        <h2 class="nk-block-title">Customer Report</h1>
...
<div class="nk-block">
    ...
    <th class="tb-col tb-col-start"><span class="overline-title">Name</span></th>
    <th class="tb-col tb-col-start"><span class="overline-title">Register ID</span></th>
    ...
    <?php
    $sel=mysqli_query($conn,"SELECT * FROM billing where name!='' and status!='' and mobile_num!='' and remarks!='' and array_price!='' ORDER BY date desc");
    ...
    <td class="tb-col">
        <a href="invoice-preview.html" class="text-light"><?=$fe['name'];?></a></td>
        <td class="tb-col"><a href="#" class="text-dark">CID<?=$fe['id'];?></a></td>
...
?>
        ...
        <td class="tb-col tb-col-xl">
            ...
            <a id="hi" href="delete-rp2.php?id=<?=$fe['id'];?>" onclick="return confirm('Are you sure want tot delete this customer')">
