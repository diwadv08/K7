...
<div class="nk-block-head-content">
    ...
    <li>&nbsp;&nbsp;<a href="expenses.php" class="btn btn-danger">Back</a></li>
</ul></div></div></div>
<div class="nk-block">
<div class="card">
...
<div class="row">
    <form method="post">
        <div class="col-6 m-4 d-flex">
            ...
            <div class="col-5" style='margin-left:40px;margin-top:25px'>
...
<?php
    ...
    $sel=mysqli_query($conn,"SELECT * FROM maintainance where date<='".$_POST['max']."' and date>='".$_POST['min']."'");
...
<?php    
    ...
    $sel3=mysqli_query($conn,"SELECT * FROM product");
...
$sel3a=mysqli_query($conn,"SELECT sum(base_price) FROM product");
...
<?php
$sel3=mysqli_query($conn,"SELECT * FROM salesorder");
    if(mysqli_num_rows($sel3)>0){
        while($fe1=mysqli_fetch_assoc($sel3)){
?>            
        <tr>
...
$sel3a=mysqli_query($conn,"SELECT sum(vendor_charge) FROM salesorder");
    if(mysqli_num_rows($sel3a)>0){
        $fh=mysqli_fetch_array($sel3a);
        $sum1so=$fh[0];
    }
...
<?php
$sel333=mysqli_query($conn,"SELECT * FROM maintainance");
...
$sel3a1=mysqli_query($conn,"SELECT sum(charge) FROM maintainance");
