...
<div class="nk-block-head-content"><ul class="d-flex"><li>
    <a href="products.php" class="btn btn-primary btn-md d-md-none">
        <em class="icon ni ni-eye"></em><span>View</span></a></li><li>
    <a href="products.php" class="btn btn-success d-none d-md-inline-flex"><em class="icon ni ni-eye"></em><span>View All Expenses</span></a></li>
...
<div class="col-lg-6">
<div class="form-control-wrap">
<label class="form-label">In Warehouse</label>
