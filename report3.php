...
<div class="nk-block-head-content"><h2 class="nk-block-title">Billing Reports   </h2>
<nav>
...
<div class="dropdown-content py-1">
    <ul class="link-list link-list-hover-bg-primary link-list-md">
        <li>
            ...
            <span>Edit</span></a>
            <a id="hi" href="delete-rp3.php?id=<?=$fe['id'];?>" onclick="return confirm('Are you sure want to delete this product')">
