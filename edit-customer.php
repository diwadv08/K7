...
<select class="form-select" name="category" id="category">
        <option value="Retail"<?php if($fe['status']=='retail' ||$fe['status']=='Retail' ){echo "selected";}?>>Retail</option>
        <option value="Wholesale"<?php if($fe['status']=='Wholesale' ||$fe['status']=='wholesale'){echo "selected";}?>>Wholesale</option>
    </select>    
</div></div></div>
<div class="col-lg-3">
...
<div class="form-control-wrap">
    <textarea class="form-control" id="address" name="address" placeholder="Enter your address"><?=$fe['address'];?></textarea></div></div></div>
    <div class="col-lg-6">
<div class="form-group"><label for="remarks" class="form-label">Remarks<spam>*</spam></label>
<div class="form-control-wrap">
    <textarea class="form-control" id="remarks" name="remarks" placeholder="Mention remarks if any"><?=$fe['remarks'];?></textarea></div></div></div>
</div> 
    <div class="col-lg-3">
...
<?php
    if(isset($_POST['save'])){
        $upd=mysqli_query($conn,"UPDATE billing
                set name='".$_POST['name']."',
                date='".$_POST['date']."',
