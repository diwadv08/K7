...
if(isset($_POST['save1'])){       
    $ins1=mysqli_query($conn,"INSERT INTO quotation (qid,q_name,idie,
    q_address,q_mob ,date,
    bar_id,q_desc ,q_price,
    quantity ,tax,discount,
    remarks) VALUES ('".$_POST['qid1']."','".$_POST['q_name1']."','".$_POST['idie1']."',
    '".$_POST['q_address1']."','".$_POST['q_mob1']."',
    '".$_POST['date1']."','".$_POST['bar_id1']."','".$_POST['q_desc1']."','".$_POST['q_price1']."','".$_POST['quantity1']."',
    '".$_POST['tax1']."','".$_POST['discount1']."','".$_POST['remarks1']."')");
}
?>
<style>
    .overline-title{
...
<tbody>
    <tr>
    <?php
        $total=$_POST['quantity1']*$_POST['q_price1'];
    ?>        
    <td class="tb-col"><span></span><?=$_POST['qid1'];?></td>
    <td class="tb-col"><span></span><?=$_POST['bar_id1'];?></td>
    <td class="tb-col"><span></span><?=$_POST['q_desc1'];?></td>
    <td class="tb-col"><span></span><?=$_POST['q_price1'];?>.00</td>
    <td class="tb-col"><span></span><?=$_POST['quantity1'];?></td>
   ...
   <tfoot><tr>
    ...
    <td colspan="4"></td>
    <td >Tax (<?=$_POST['tax1'];?>%):</td>
    <td class="tb-col-end">(+)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $t=$_POST['tax1']*($total/100);?></td></tr>
    <tr>
    <td colspan="4"></td>
    <td >Discount(<?=$_POST['discount1'];?>%):</td>
    <td class="tb-col-end">(-)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $t1=$_POST['discount1']*($total/100);?></td></tr>
    <tr>
    <td colspan="4"></td>
